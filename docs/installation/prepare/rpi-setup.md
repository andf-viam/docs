...
If you see the error `error: can't read from I2C address` in your logs after installing `viam-server`, you will need to enable `I2C` support on your Raspberry Pi.
